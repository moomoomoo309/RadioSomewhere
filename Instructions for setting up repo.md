# Instructions for setting up RadioSomewhere Repo:
...
## Sublime Text 2/3:
  ...
  * Go to tools->build system, and switch it to Love.
	  * Press ctrl+shift+p, run git: clone, enter https://github.com/moomoomoo309/RadioSomewhere as the URL.
  ...
  * Run git config remote.origin.url "https://{token}@github.com/moomoomoo309/RadioSomewhere.git"
  ...
  * To make sure it works, hit ctrl+shift+p and run git: commit, and follow the instructions there.
     ...
     * Go to [the repo](https://github.com/moomoomoo309/RadioSomewhere) and you should see your commit.  
...
## IntelliJ-based IDEs (PyCharm, IntelliJ, etc.):
  ...
  * Go to New->Project from Version Control->GitHub, and use the following URL.
     * https://github.com/moomoomoo309/RadioSomewhere
