return {
    "#thomas: Hey Carl, thank god man. Things have really gone to shit huh?",
    {
        ["#uwsss: I'm sorry this isn't Carl."] = {
            ...
            "#thomas: It’s just quiet. Total radio silence except for some stray transmissions breaking through here and there. The world ain’t exactly blowing up. It’s softer than that. Like we’re all just waiting to fall asleep. We all know it’s coming. We don’t know when, just soon.",
            "#uwsss: Damn. That’s a lot.",
            "#thomas: Yeah, I’m afraid there's not much left to do but pour yourself a drink and wait. I wanted to get in touch with my old buddy to have one last drink with him, but I guess that ain’t gonna happen.",
            ...
            "#thomas: He was a hell of a guy. Carl always used to pick out the right drink. Tequila to celebrate a good day, whiskey sour to cap off a bad one, cold beer to stretch out a sunday afternoon. The man had taste.",
            "#thomas: Actually, could you pick a drink for me? Never could pick out booze for shit. I’ve got it all here. From Budweiser to Black Label.",
            {
                ["#uwsss: Whiskey sour"] = {
                    ...
                    "#thomas: Ya know, Carl used to say that whiskey tasted like melancholy. Not in a bad way. He always ordered it for me when I needed something bitter sweet. Not a bad choice for the end of the world",
                ...
                ["#uwsss: Tequila"] = {
                    ...
                    "#thomas: Can’t think of a better way to celebrate the end of days. Carl actually didn't like tequila all that much, but he insisted on drinking it. He said that if you want to party, you gotta kick it off with tequila",
                },
                ["#uwsss: Beer"] = {
                    "#thomas: I was kinda hoping you’d say that.",
                    "#thomas: As good as all this fancy crap is, there’s nothing better than a simple brew. I must’ve spat out half of my first beer. I must’ve been 15. Me and Carl used to beers out of his dads fridge. Ya know Carl never did acquire much of a taste for beer. He always said it was good, but too plain. I Don’t think so though. Under the hopps, there’s a sort of nostalgia to ‘em.",
                },
            },
